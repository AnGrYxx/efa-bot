    ...
    constructor(transporter, options, defaults) {
        ...
        this._defaultPlugins = {
            compile: [function (/*...args*/) {
                return this._convertDataImages.apply(this, arguments);
            }.bind(this)],
            stream: []
        };
        ...
        if (typeof transporter.on === 'function') {
            ...
            this.transporter.on('idle', function (/*...args*/) {
                this.emit.apply(this, ['idle'].concat(arguments));
            }.bind(this));
        }
        ...
        ['close', 'isIdle', 'verify'].forEach(method => {
            this[method] = function (/*...args*/) {
                if (typeof this.transporter[method] === 'function') {
                    return this.transporter[method].apply(this.transporter, arguments);
                } else {
                    this.logger.warn({
                        tnx: 'transport',
                        methodName: method
    ...
    sendMail(data, callback) {
        ...
        this._processPlugins('compile', mail, err => {
            ...
            this._processPlugins('stream', mail, err => {
                ...
                this.transporter.send(mail, function (/*...args*/) {
                    if (arguments[0]) {
                        this.logger.error({
                            err: arguments[0],
                            tnx: 'transport',
                            action: 'send'
                        }, 'Send Error: %s', arguments[0].message);
                    }
