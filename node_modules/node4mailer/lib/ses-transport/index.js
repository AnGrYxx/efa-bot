...
class SESTransport extends EventEmitter {
    ...
    send(mail, callback) {
        ...
        this._send(mail, function (/*...args*/) {
            setImmediate(() => callback.apply(null, arguments));
            this._sent();
        }.bind(this));
    }
    ...
    _checkRatedQueue() {
        ...
        this._send(next.mail, function (/*...args*/) {
            setImmediate(() => next.callback.apply(this, arguments));
            this._sent();
        }.bind(this));
    }
